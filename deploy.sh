...
kubectl set image deployments/client-deployment server=mohsin17/multi-client:$SHA
kubectl set image deployments/worker-deployment server=mohsin17/multi-worker:$SHA
